...
PMSX003_TYPES = {
    ...
    CONF_PMS5003: PMSX003Type.PMSX003_TYPE_5003,
    CONF_PMS5003T: PMSX003Type.PMSX003_TYPE_5003T,
    CONF_PMS5003ST: PMSX003Type.PMSX003_TYPE_5003ST,
}

SENSORS_TO_TYPE = {
    CONF_PM_1_0: [CONF_PMSX003, CONF_PMS5003],
    CONF_PM_2_5: [CONF_PMSX003, CONF_PMS5003, CONF_PMS5003T, CONF_PMS5003ST],
    CONF_PM_10_0: [CONF_PMSX003, CONF_PMS5003],
